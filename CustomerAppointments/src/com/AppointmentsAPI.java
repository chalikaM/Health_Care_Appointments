...
public class AppointmentsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String output = appointmentObj.insertAppointment(request.getParameter("A_PatientName"),request.getParameter("A_PatientNIC"),
				request.getParameter("A_PatientPhoneNo"), request.getParameter("A_DoctorName"), request.getParameter("A_HospitalName"),request.getParameter("A_Date"),request.getParameter("A_Time"));
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)
		...
		// TODO Auto-generated method stub
		Map paras = getParasMap(request);
		 String output = appointmentObj.DeleteAppointment(paras.get("A_AppointmentID").toString());
		response.getWriter().write(output); 
