		...
		<div class="row">
			<div class="col-6">
				...
				<form id="formAppointment" name="formAppointment" method="post"
					...
					Patient Name : <input id="A_PatientName" name="A_PatientName"
						type="text" class="form-control form-control-sm"> <br>
					Patient NIC : <input id="A_PatientNIC" name="A_PatientNIC"
						type="text" class="form-control form-control-sm"> <br>
					Patient Phone Number : <input id="A_PatientPhoneNo"
						name="A_PatientPhoneNo" type="text"
						class="form-control form-control-sm"> <br> Doctor
					Name : <input id="A_DoctorName" name="A_DoctorName" type="text"
						class="form-control form-control-sm"> <br> Hospital
					Name : <input id="A_HospitalName" name="A_HospitalName" type="text"
						class="form-control form-control-sm"> <br> Date : <input
						id="A_Date" name="A_Date" type="text"
						class="form-control form-control-sm"> <br> Time : <input
						id="A_Time" name="A_Time" type="text"
